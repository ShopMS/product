...
var (
	filter_ProductAPI_GetProducts_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_ProductAPI_GetProducts_0(ctx context.Context, marshaler runtime.Marshaler, client ProductAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ProductAPI_GetProducts_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterProductAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProductAPIServer) error {
	...
	mux.Handle("GET", pattern_ProductAPI_GetProducts_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
